...
- cover image path and alt text
- summary and role
- focus tags
- optional YouTube link and label
- gallery images with captions and layout ratios
...
2. Review and refine project captions, image ordering, and alt text now that the real assets are present
