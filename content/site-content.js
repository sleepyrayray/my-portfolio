  ...
  projects: [
    {
      ...
      process: [
        ...
        },
        {
          ...
          text:
            "Environment assets, quiet pacing, and AI-generated voice lines helped create a reflective tone around helping Seraphina in a forest setting.",
        },
      ],
      takeaways: [
        "Learned how to translate a story idea into a playable, explorable structure.",
    ...
    },
    {
      ...
      contributions: [
        ...
        "Wrote dialogue and shaped Sheldon’s reactions so the turtle felt expressive and responsive.",
      ],
      process: [
        {
        ...
        },
        {
          ...
          text:
            "The interface, visuals, and dialogue were designed to keep the experience calm, approachable, and emotionally readable.",
        },
        {
      ...
      takeaways: [
        "Deepened experience designing around soft emotional feedback rather than challenge.",
    ...
    },
    {
      ...
      contributions: [
        ...
        "Worked through iteration challenges around the seesaw mechanism and sensor-driven motion.",
      ],
      process: [
        {
          title: "Prototype before polishing",
          text:
            "The team first tested ideas with simple foam and micro:bit motor setups, then evolved the mechanism after seeing what did and did not work.",
        },
        {
          title: "Make the action legible",
          text:
            "The final interaction used light sensors so players could clearly connect the flashlight input with the lowering vampire heads.",
        },
        {
          title: "Tie the look to the mechanic",
          text:
            "Red and black materials, cardboard construction, and themed labeling gave the prototype a stronger arcade identity without overcomplicating the build.",
        },
      ],
      takeaways: [
        "Gained more confidence designing around electronics and physical feedback loops.",
    ...
    },
    {
      ...
      contributions: [
        ...
        "Participated in balancing, pacing adjustments, rulebook cleanup, and card-set refinement after playtests.",
      ],
      process: [
        {
          title: "Lead with structure",
          text:
            "The game was framed around MDA thinking, making sure the villain fantasy translated into mechanics, pacing, and player decisions.",
        },
        {
          title: "Balance through playtests",
          text:
            "Rough prototypes helped reveal where numbers, HP values, and progression needed adjustment to keep the cooperative experience tense but fair.",
        },
        {
          title: "Build a readable system",
          text:
            "Ability types, branching paths, companions, and rulebook clarity were refined so new players could understand the game without losing its strategic depth.",
        },
      ],
      takeaways: [
        "Strengthened system-design thinking around pacing, balance, and readability.",
    ...
    },
    {
      ...
      process: [
        {
          title: "Start from the ordinary",
          text:
            "The project began with close observation of everyday surfaces and an interest in how grounded materials could suggest something more imaginative.",
        },
        {
          title: "Find images within textures",
          text:
            "Pareidolia became a design tool, helping reveal possible forms, moods, and stories hidden within the rubbings.",
        },
        {
          title: "Transform texture into narrative",
          text:
            "Each finished work pushed the same source material toward a different emotional register, from uplifting to eerie.",
        },
      ],
      takeaways: [
        "Developed a stronger eye for seeing composition and symbolism inside raw texture.",
